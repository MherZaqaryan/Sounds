...
public class FastBoard {
    ...
    /** The Constant VERSION_TYPE. */
    private static final VersionType VERSION_TYPE;

    /** The Constant PLAYER_CONNECTION. */
    // Packets sending
    private static final Field PLAYER_CONNECTION;
    
    /** The Constant SEND_PACKET. */
    private static final Method SEND_PACKET;
    
    /** The Constant PLAYER_GET_HANDLE. */
    private static final Method PLAYER_GET_HANDLE;

    /** The Constant CHAT_COMPONENT_CLASS. */
    // Chat components
    private static final Class<?> CHAT_COMPONENT_CLASS;
    
    /** The Constant MESSAGE_FROM_STRING. */
    private static final Method MESSAGE_FROM_STRING;

    /** The Constant PACKET_SB_OBJ. */
    // Scoreboard packets
    private static final Constructor<?> PACKET_SB_OBJ;
    
    /** The Constant PACKET_SB_DISPLAY_OBJ. */
    private static final Constructor<?> PACKET_SB_DISPLAY_OBJ;
    
    /** The Constant PACKET_SB_SCORE. */
    private static final Constructor<?> PACKET_SB_SCORE;
    
    /** The Constant PACKET_SB_TEAM. */
    private static final Constructor<?> PACKET_SB_TEAM;

    /** The Constant ENUM_SB_HEALTH_DISPLAY. */
    // Scoreboard enums
    private static final Class<?> ENUM_SB_HEALTH_DISPLAY;
    
    /** The Constant ENUM_SB_ACTION. */
    private static final Class<?> ENUM_SB_ACTION;
    
    /** The Constant ENUM_SB_HEALTH_DISPLAY_INTEGER. */
    private static final Object ENUM_SB_HEALTH_DISPLAY_INTEGER;
    
    /** The Constant ENUM_SB_ACTION_CHANGE. */
    private static final Object ENUM_SB_ACTION_CHANGE;
    
    /** The Constant ENUM_SB_ACTION_REMOVE. */
     ...
     */
    protected FastBoard(Player player) {
    ...
    /**
     * Gets the score by line.
     *
     * @param line the line
     * @return the score by line
     */
    ...
    /**
     * Gets the line by score.
     *
     * @param score the score
     * @return the line by score
     */
 ...
 UPDATE
    ...
    enum TeamMode {
        ...
        CREATE, /** The remove. */
 REMOVE, /** The update. */
 UPDATE, /** The add players. */
 ADD_PLAYERS, /** The remove players. */
 REMOVE_PLAYERS

    }

    /**
     * The Enum ScoreboardAction.
     */
 ...
 V1_13;
        ...
        /**
         * Checks if is higher or equal.
         *
         * @return true, if is higher or equal
         */
